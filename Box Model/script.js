...
intrinsicSwitch.addEventListener("change", () => {
    ...
    if(intrinsicSwitch.checked){
        awesome.setAttribute(
            "data-sizing", "intrinsic"
        );
        intrinsicSwitch.value = "intrinsic";
    }else{
        awesome.setAttribute(
            "data-sizing", "extrinsic"
        );
        intrinsicSwitch.value = "extrinsic";
    }
});

}

function sizingBoxImage(){
